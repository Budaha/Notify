...
import preloaderComponent from "@/components/UI/Preloader.vue";
export default {
  name: "notifyPage",
  components: { notifyComponent, preloaderComponent },
  data() {
    return {
      loading: false,
      error: null,
